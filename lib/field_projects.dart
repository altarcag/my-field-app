...
class GpsTrack {
  ...
  GpsTrack finish(DateTime time) =>
      GpsTrack(id: id, startedAt: startedAt, endedAt: time, points: points);
...
class FieldProjectStore {
  FieldProjectStore({this.storageDirectory});
  ...
  Future<String> importPhoto(
    ...
    if (!allowed.contains(extension)) {
      throw const FormatException(
        'Choose a JPEG, PNG, or WebP photo for My Field Atlas',
      );
    }
